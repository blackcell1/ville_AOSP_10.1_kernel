...
static int __init cpufreq_interactivex_init(void)
{
	...
	int (*new_sched_setscheduler_nocheck)(struct task_struct *p, int policy,
			       const struct sched_param *param);
	ulong addr;
	addr = kallsyms_lookup_name("sched_setscheduler_nocheck");
	new_sched_setscheduler_nocheck = (void *)addr;
	...
	new_sched_setscheduler_nocheck(up_task, SCHED_FIFO, &param);
