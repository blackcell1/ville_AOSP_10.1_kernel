...
static struct l2_level l2_freq_tbl_8960_kraitv2[] = {
	...
	[20] = { { 1512000, HFPLL, 1, 0, 0x34 }, 1150000, 1150000, 8 },
	[21] = { { 1674000, HFPLL, 1, 0, 0x36 }, 1150000, 1150000, 8 },
	[22] = { { 1728000, HFPLL, 1, 0, 0x38 }, 1150000, 1150000, 9 },
};

#ifndef CONFIG_OVERVOLT
#define OV_GAP 0
#define OV_ADJUST 0
#define OV_ADJUST2 0
#else /*OVERVOLT*/
#ifdef CONFIG_OVERVOLT_SOFT
#define OV_GAP 75000
#define OV_ADJUST 25000
#define OV_ADJUST2 50000
#else /*OVERVOLT_SOFT*/
#ifdef CONFIG_OVERVOLT_MEDIUM
#define OV_GAP 125000
#define OV_ADJUST 37500
#define OV_ADJUST2 62500
#else /*OVERVOLT_MEDIUM*/
#define OV_GAP 150000
#define OV_ADJUST 50000
#define OV_ADJUST2 75000
#endif/*OVERVOLT_MEDIUM*/
#endif /*OVERVOLT_SOFT*/
#endif /*OVERVOLT*/

static struct acpu_level acpu_freq_tbl_8960_kraitv2_slow[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   850000 + OV_GAP},
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(1),   900000 + OV_GAP},
	{ 1, {   384000, HFPLL, 2, 0, 0x20 }, L2(7),   900000 + OV_GAP},
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   950000 + OV_GAP},
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(7),  1000000 + OV_GAP},
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),  1000000 + OV_GAP},
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),  1025000 + OV_GAP - OV_ADJUST},
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(7),  1025000 + OV_GAP - OV_ADJUST},
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(7),  1075000 + OV_GAP - OV_ADJUST},
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(7),  1075000 + OV_GAP - OV_ADJUST},
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(7),  1100000 + OV_GAP - OV_ADJUST},
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(7),  1100000 + OV_GAP - OV_ADJUST},
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(7),  1125000 + OV_GAP - OV_ADJUST},
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(7),  1125000 + OV_GAP - OV_ADJUST},
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(16), 1175000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(16), 1175000 + OV_GAP - OV_ADJUST2},
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(16), 1200000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(16), 1200000 + OV_GAP - OV_ADJUST2},
	{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(16), 1225000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(16), 1225000 + OV_GAP - OV_ADJUST2},
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(16), 1237500 + OV_GAP - OV_ADJUST2},
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(16), 1237500 + OV_GAP - OV_ADJUST2},
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(20), 1250000 + OV_GAP - OV_ADJUST2},
#ifndef CONFIG_MSM_CPU_MAX_CLK_1DOT5GHZ
	{ 1, {  1674000, HFPLL, 1, 0, 0x3A }, L2(20), 1275000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1728000, HFPLL, 1, 0, 0x3C }, L2(21), 1300000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1809000, HFPLL, 1, 0, 0x3E }, L2(21), 1325000 + OV_GAP - OV_ADJUST2},
#ifndef CONFIG_MSM_CPU_MAX_CLK_1DOT7GHZ
	{ 1, {  1890000, HFPLL, 1, 0, 0x40 }, L2(22), 1350000 + OV_GAP - OV_ADJUST2},
#ifndef CONFIG_MSM_CPU_MAX_CLK_1DOT89GHZ
	{ 1, {  1998000, HFPLL, 1, 0, 0x42 }, L2(22), 1350000 + OV_GAP - OV_ADJUST2},
	{ 1, {  2106000, HFPLL, 1, 0, 0x44 }, L2(22), 1350000 + OV_GAP - OV_ADJUST2},
#endif
#endif
#endif
	{ 0, { 0 } }
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   800000 + OV_GAP},
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(1),   800000 + OV_GAP},
	{ 1, {   384000, HFPLL, 2, 0, 0x20 }, L2(7),   850000 + OV_GAP},
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   900000 + OV_GAP},
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(7),   950000 + OV_GAP},
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),   950000 + OV_GAP},
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),   975000 + OV_GAP - OV_ADJUST},
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(7),   975000 + OV_GAP - OV_ADJUST},
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(7),  1025000 + OV_GAP - OV_ADJUST},
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(7),  1025000 + OV_GAP - OV_ADJUST},
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(7),  1050000 + OV_GAP - OV_ADJUST},
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(7),  1050000 + OV_GAP - OV_ADJUST},
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(7),  1075000 + OV_GAP - OV_ADJUST},
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(7),  1075000 + OV_GAP - OV_ADJUST},
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(16), 1100000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(16), 1125000 + OV_GAP - OV_ADJUST2},
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(16), 1125000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(16), 1150000 + OV_GAP - OV_ADJUST2},
	{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(16), 1150000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(16), 1175000 + OV_GAP - OV_ADJUST2},
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(16), 1175000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(16), 1187500 + OV_GAP - OV_ADJUST2},
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(18), 1200000 + OV_GAP - OV_ADJUST2},
#ifndef CONFIG_MSM_CPU_MAX_CLK_1DOT5GHZ
	{ 1, {  1674000, HFPLL, 1, 0, 0x3A }, L2(18), 1225000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1728000, HFPLL, 1, 0, 0x3C }, L2(19), 1250000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1809000, HFPLL, 1, 0, 0x3E }, L2(19), 1275000 + OV_GAP - OV_ADJUST2},
#ifndef CONFIG_MSM_CPU_MAX_CLK_1DOT7GHZ
	{ 1, {  1890000, HFPLL, 1, 0, 0x40 }, L2(19), 1300000 + OV_GAP - OV_ADJUST2},
#ifndef CONFIG_MSM_CPU_MAX_CLK_1DOT89GHZ
	{ 1, {  1998000, HFPLL, 1, 0, 0x42 }, L2(19), 1325000 + OV_GAP - OV_ADJUST2},
	{ 1, {  2106000, HFPLL, 1, 0, 0x44 }, L2(19), 1350000 + OV_GAP - OV_ADJUST2},
#endif
#endif
#endif
	{ 0, { 0 } }
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_fast[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   800000 + OV_GAP},
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(1),   800000 + OV_GAP},
	{ 1, {   384000, HFPLL, 2, 0, 0x20 }, L2(7),   800000 + OV_GAP},
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   850000 + OV_GAP},
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(7),   900000 + OV_GAP},
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),   900000 + OV_GAP},
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),   925000 + OV_GAP - OV_ADJUST},
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(7),   925000 + OV_GAP - OV_ADJUST},
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(7),   975000 + OV_GAP - OV_ADJUST},
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(7),   975000 + OV_GAP - OV_ADJUST},
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(7),  1000000 + OV_GAP - OV_ADJUST},
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(7),  1000000 + OV_GAP - OV_ADJUST},
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(7),  1025000 + OV_GAP - OV_ADJUST},
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(7),  1025000 + OV_GAP - OV_ADJUST},
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(16), 1075000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(16), 1075000 + OV_GAP - OV_ADJUST2},
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(16), 1100000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(16), 1100000 + OV_GAP - OV_ADJUST2},
	{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(16), 1125000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(16), 1125000 + OV_GAP - OV_ADJUST2},
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(16), 1125000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(16), 1137500 + OV_GAP - OV_ADJUST2},
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(18), 1150000 + OV_GAP - OV_ADJUST2},
#ifndef CONFIG_MSM_CPU_MAX_CLK_1DOT5GHZ
	{ 1, {  1674000, HFPLL, 1, 0, 0x3A }, L2(18), 1175000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1728000, HFPLL, 1, 0, 0x3C }, L2(19), 1200000 + OV_GAP - OV_ADJUST2},
	{ 1, {  1809000, HFPLL, 1, 0, 0x3E }, L2(19), 1250000 + OV_GAP - OV_ADJUST2},
#ifndef CONFIG_MSM_CPU_MAX_CLK_1DOT7GHZ
	{ 1, {  1890000, HFPLL, 1, 0, 0x40 }, L2(19), 1275000 + OV_GAP - OV_ADJUST2},
#ifndef CONFIG_MSM_CPU_MAX_CLK_1DOT89GHZ
	{ 1, {  1998000, HFPLL, 1, 0, 0x42 }, L2(19), 1300000 + OV_GAP - OV_ADJUST2},
	{ 1, {  2106000, HFPLL, 1, 0, 0x44 }, L2(19), 1325000 + OV_GAP - OV_ADJUST2},
#endif
#endif
#endif
	{ 0, { 0 } }
